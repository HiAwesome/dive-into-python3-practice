...
class ToRomanBadInput(unittest.TestCase):
    def test_too_large(self):
        ...
        self.assertRaises(roman.OutOfRangeErrer, roman.to_roman, 5000)

    def test_zero(self):
        """to_roman should fail with 0 input"""
        self.assertRaises(roman.OutOfRangeErrer, roman.to_roman, 0)

    def test_negative(self):
        """to_roman should fail with negative input"""
        self.assertRaises(roman.OutOfRangeErrer, roman.to_roman, -1)
...
class FromRomanBadInput(unittest.TestCase):
    ...
    def test_malformed_antecedents(self):
        ...
        for s in ('IIMXCC', 'VX', 'DCM', 'CMM', 'IXIV', 'MCMC', 'XCX', 'IVI', 'LM', 'LD'):
            self.assertRaises(roman.InvalidRomanNumeralError, roman.from_roman, s)
